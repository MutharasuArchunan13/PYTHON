"""TUPLES : previously i know java in java the string concept is there and 
commanly they say string is immutable(but use alternatives it's possible),
in python also that same concept is ther but here it's called tuples and use 
paranthesis instead of []
"""
